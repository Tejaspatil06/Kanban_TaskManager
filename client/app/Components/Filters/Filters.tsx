...
function Filters() {
  ...
  return (
    <div className="relative py-2 px-2 grid grid-cols-4 items-center gap-3 bg-[#4A5FBD] border-2 border-white rounded-md">
      <span
      ...
      {priorities.map((priority, index) => (
        <button
          ...
          className={`relative px-1 z-10 font-medium text-sm ${
            activeIndex === index ? "text-[#3aafae] " : "text-white-500"
          }`}
          onClick={() => {
